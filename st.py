...
def main():
    ...
    if st.button("Generate Question Paper"):
        ...
        # Step 2: Initialize vector store using the uploaded PDF
        vectorstore = vectorstore_manager.process_file(file_path=pdf_file_path)

        # Step 3: Initialize the language model
        llm_model = LLModel.initialize_llm(model_name="groq")

        # Step 4: Initialize QGen
