...
def get_huggingface_inference_embedding(model_name:str,api_key=None):
    api_key = api_key or get_api_key("hf")
    return HuggingFaceInferenceAPIEmbeddings(model_name=model_name,api_key=api_key)
...
def get_embedding_hf(model_name="sentence-transformers/all-mpnet-base-v2"):
    return HuggingFaceEmbeddings(model_name=model_name)
